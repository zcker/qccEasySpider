...
## 操作
在dist目录下的exe文件可以直接运行，使用pyinstaller编译
在enterprise_search文档中写入公司名并运行写入info.xls
![1.png](https://s2.loli.net/2022/02/10/BbOzMYowu98LdXI.png)
## 修改
使用两种匹配模式，一种将HTML下载下来操作，是原来的，但是HTML对于正则不好用
所以我增加了使用requests+bs4的方法，写的很简陋，能用就行
